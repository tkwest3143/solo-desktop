      ...
      <div class="flex items-center justify-between">
        ...
        <div class="text-right">
          <div class="text-sm text-slate-500">
            {{
              mode === "pomodoro"
                ? `セッション ${state.currentSessionCount + 1}`
                : "カウントアップ中"
            }}
          </div>
      ...
      <div class="max-w-4xl mx-auto">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
              <div class="text-center">
                ...
                <div class="flex items-center justify-center space-x-2">
                  ...
                  >
                    <Icon
                      name="fluent:arrow-reset-20-filled"
                      class="mr-2"
                      size="1.2em"
                    />
                    リセット
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          >
            ...
            >
              <Icon
                name="fluent:data-bar-horizontal-20-filled"
...
export default defineComponent({
  ...
  setup() {
    ...
    const totalFocusTime = computed(() => {
      return (
        timer.state.value.completedFocusSessions *
        timer.state.value.pomodoroSettings.focusTime
      );
    });
