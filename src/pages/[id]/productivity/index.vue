<template>
  <div class="h-full bg-white">
    ...
    <div class="p-8 border-b border-slate-200">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-slate-600">ポモドーロタイマーで生産性を最大化</p>
        </div>
    ...
    <div class="p-8">
      <!-- Feature Cards -->
      <div class="grid grid-cols-1 lg:grid-cols-1 gap-6 mb-8 max-w-md mx-auto">
        <!-- Pomodoro Timer Card -->
      ...
      <div class="bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-4 max-w-md mx-auto">
