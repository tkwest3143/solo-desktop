<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-6">
    <div class="bg-white rounded-xl shadow-xl border border-slate-200 p-8 w-full max-w-md">
      <div class="text-center mb-8">
        <div class="mx-auto w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center mb-4">
          <Icon name="fluent:person-add-20-filled" size="2em" class="text-white" />
        </div>
        <h1 class="text-2xl font-bold text-slate-800 mb-2">ユーザ追加</h1>
        <p class="text-slate-600 text-sm">新しいユーザー情報を入力してください</p>
      </div>
